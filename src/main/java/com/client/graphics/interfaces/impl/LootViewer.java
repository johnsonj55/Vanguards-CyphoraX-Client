...
public class LootViewer extends RSInterface {
    ...
    private enum Button {
        ...
        FOE_MYSTERY_CHEST("Insane Mystery Chest", 8167),
        ...
        KRATOS_CHEST("Kratos Chest", 7302),
        NIGHTMARE_CHEST("Nightmare Chest", 4185),
        SEREN_CHEST("Seren Chest", 6792),
        LOYALTY_CHEST("Loyalty Chest", 691),
        SLAYER_CHEST("Slayer Chest", 21053),
        GALVEK_EVENT("Galvek Event", 16017),
        MALEDICTUS_EVENT("Maledictus Event", 16012),
        SEA_SNAKE("Powerful Sea Snake", 995),
        NEX("Nex", 26382)
        ;
    ...
    public int getButtons(TextDrawingArea[] tda, int id) {
        ...
        inter.height = 263;
        inter.width = 176;
        inter.scrollMax = inter.height + 480;//215 - change this to add more buttons
