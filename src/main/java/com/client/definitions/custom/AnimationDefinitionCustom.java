    ...
    public static void custom(int j, AnimationDefinition[] anims) {
        ...
        switch (j) {
            case 451:
                ...
                anim.playerOffhand = -1;
                anim.playerMainhand = -1;
                anim.maximumLoops = 99;
                anim.animatingPrecedence = 2; // need this to 2 and add the anIntArray357 to fix movement stalling
                anim.priority = 0;
                anim.frameCount = 10;
            ...
            case 7553:
                ...
                anim.stretches = false;
                anim.forcedPriority = 5;
                anim.playerOffhand = 0;
                anim.playerMainhand = 2992;
                anim.maximumLoops = 2;
                anim.animatingPrecedence = 2;
                anim.priority = 2;
                anim.frameCount = 15;
