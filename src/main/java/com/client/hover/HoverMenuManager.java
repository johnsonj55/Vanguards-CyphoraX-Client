...
public class HoverMenuManager {
    ...
    public static void init() {
        ...
        menus.put(6806, new HoverMenu("When used with the ring of Cyphora +12% droprate bonus."));//runerogue imbue scroll
        ...
        menus.put(30022, new HoverMenu("The most powerful pet on CyphoraX."));//Kratos
        menus.put(30122, new HoverMenu("The most powerful pet on CyphoraX."));//Dark Kratos
        ...
        System.out.println("CyphoraX has loaded " + menus.size() + "x menu hovers.");
    }
