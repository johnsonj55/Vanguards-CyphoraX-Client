...
public class QuestTab extends RSInterface {
    ...
    public static final int DEFAULT_SCROLL_MAX = 760;//Change this to make the scroll bar longer
    ...
    private enum Button {
        INFORMATION(1, DEFAULT_SCROLL_MAX + 200),//200
    ...
    public static void questTab(TextDrawingArea[] tda) {
      ...
      //  infoList.scrollMax = 700;
        ...
        int size = 65;//Change this to make the info tab have more lines
        ...
        for (int id = 0; id < size; id++) {
            ...
            infoList.child(id, interfaceId, 2, 5 + (id * 16));//16
        }
...
//        }
    ...
    public static void infoTab(TextDrawingArea[] tda) {
        ...
        CoinTab[] tabs = {
                ...
                new CoinTab("Discord", 2, 30, 7),
                new CoinTab("Achievements", 2, 50, 7),
